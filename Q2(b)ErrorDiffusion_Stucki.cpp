...
int main(int argc, char *argv[]) {
    ...
    // ERROR DIFFUSION USING STUCKI ERROR DIFFUSION MATRIX
    // For 5*5 Filter
    ...
    for(int i = 0; i< length; i++){
        if(i % 2 == 0) { // Odd Rows
            for(int j = 0; j< width; j++){
                ...
                NewImagedataFive[i+1][j + 2][0] += e * 8 / 42.0;
                NewImagedataFive[i+1][j + 3][0] += e * 4 / 42.0;
                NewImagedataFive[i + 2][j - 1][0] += e * 2 / 42.0;
                NewImagedataFive[i + 2][j][0] += e * 4 / 42.0;
                NewImagedataFive[i + 2][j + 1][0] += e * 8 / 42.0;
                NewImagedataFive[i + 2][j + 2][0] += e * 4 / 42.0;
                NewImagedataFive[i + 2][j + 3][0] += e * 2 / 42.0;
                NewImagedataFive[i + 3][j - 1][0] += e * 1 / 42.0;
                NewImagedataFive[i + 3][j][0] += e * 2 / 42.0;
                NewImagedataFive[i + 3][j + 1][0] += e * 4 / 42.0;
                NewImagedataFive[i + 3][j + 2][0] += e * 2 / 42.0;
                NewImagedataFive[i + 3][j + 3][0] += e * 1 / 42.0;
            }
        }
        else {
            for(int j = width; j >= 0; j--){//Even Rows
                ...
                e = NewImagedataFive[i+1][j+1][0] - OutputImage[i][j][0];
                NewImagedataFive[i+1][j - 1][0] += e * 8 / 42.0;
                NewImagedataFive[i+1][j][0] += e * 4 / 42.0;
                NewImagedataFive[i + 2][j - 1][0] += e * 2 / 42.0;
                NewImagedataFive[i + 2][j][0] += e * 4 / 42.0;
                NewImagedataFive[i + 2][j + 1][0] += e * 8 / 42.0;
                NewImagedataFive[i + 2][j + 2][0] += e * 4 / 42.0;
